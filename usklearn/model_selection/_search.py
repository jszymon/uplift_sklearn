...
def fit_grid_point(X, y, trt, n_trt, estimator, parameters, train, test, scorer,
    ...
    **fit_params : kwargs
    ...
    scores, n_samples_test = _fit_and_score(estimator, X, y, trt, n_trt,
                                            scorer, train,
...
class BaseSearchCV(MetaEstimatorMixin, BaseEstimator, metaclass=ABCMeta):
    ...
    def score(self, X, y, trt, n_trt=None):
        ...
        return score(self.best_estimator_, X, y, trt, n_trt)
    ...
    def predict_action(self, X):
        """Call predict_action on the estimator with the best found parameters.
    ...
    def fit(self, X, y, trt, n_trt=None, groups=None, **fit_params):
        ...
        **fit_params : dict of string -> object
        ...
        cv = check_cv(self.cv, y_stratify, classifier=True)
        ...
        if self.refit:
            ...
            if y is not None:
                self.best_estimator_.fit(X, y, trt, n_trt, **fit_params)
            else:
                self.best_estimator_.fit(X, trt, n_trt, **fit_params)
