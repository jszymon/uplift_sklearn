...
The version used is from the scikit-uplift package
"""
...
ARCHIVE = RemoteFileMetadata(
    ...
    checksum=('b531544f6c072d22f232d91e20ffcaca'
              '265acf224e02687502a40e6d56135682'))
...
def fetch_Lenta(data_home=None, download_if_missing=True,
                    ...
                    as_frame=False):
    """Load the Lenta dataset (uplift classification and regression).
